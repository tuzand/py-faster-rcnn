...
class schalke(imdb):
    ...
    def gt_roidb(self):
        ...
        gt_roidb = [self._load_schalke_annotation(index)
    ...
    def _load_schalke_annotation(self, index):
        """
        Load image and bounding boxes info from txt files of Schalke.
        """
    ...
    def _write_schalke_results_file(self, all_boxes):
    ...
    def _get_schalke_results_file_template(self):
